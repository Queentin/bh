...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{url('admin/login/css/font-awesome.min.css')}}" />
		...
		<link rel="stylesheet" href="{{url('admin/login/css/ace.min.css')}}" />
		<link rel="stylesheet" href="{{url('admin/login/css/ace-rtl.min.css')}}" />
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">逼乎</span>
									<span class="white">管理猿登录</span>
								</h1>
