    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="{{url('insert')}}" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red">*</i>分类：</th>
                            <td>
                                <select name="rose" id="catid" class="required">
                                    <option value="">请选择</option>
                                    <option value="0">超级管理员</option><option value="1">管理员</option>
                                </select>
                            </td>
                        </tr>
                            <tr>
                                <th><i class="require-red" id="">*</i>用户名：</th>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="repassword" size="50" value="" type="password"></td>
                            </tr>
                            <tr>
                                <th>手机：</th>
                                <td><input class="common-text" name="phone" size="50" value="" type="text"></td>
                            </tr>
